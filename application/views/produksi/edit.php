	...
	<div class="col-md-12">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">Produksi Edit</h3>
			</div>
			<?php echo form_open('produksi/edit/' . $produksi['id_produksi']); ?>
			<div class="box-body">
				<div class="row clearfix">
						...
						<div class="form-group">
							<select name="id_pesanan" class="form-control">
								...
								foreach ($all_pesanan as $pesanan) {
									$selected = ($pesanan['id_pesanan'] == $produksi['id_pesanan']) ? ' selected="selected"' : "";
						...
						<div class="form-group">
							<select name="id_karyawan" class="form-control">
								...
								foreach ($all_karyawan as $karyawan) {
									$selected = ($karyawan['id_karyawan'] == $produksi['id_karyawan']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama" value="<?php echo ($this->input->post('nama') ? $this->input->post('nama') : $produksi['nama']); ?>" class="form-control" id="nama" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="potong_terselesaikan" class="control-label"><span class="text-danger">*</span>Potong Terselesaikan</label>
						<div class="form-group">
							<input type="text" name="potong_terselesaikan" value="<?php echo ($this->input->post('potong_terselesaikan') ? $this->input->post('potong_terselesaikan') : $produksi['potong_terselesaikan']); ?>" class="form-control" id="potong_terselesaikan" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="tanggal_produksi" value="<?php echo ($this->input->post('tanggal_produksi') ? $this->input->post('tanggal_produksi') : $produksi['tanggal_produksi']); ?>" class="form-control" id="tanggal_produksi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="ket" value="<?php echo ($this->input->post('ket') ? $this->input->post('ket') : $produksi['ket']); ?>" class="form-control" id="ket" />
