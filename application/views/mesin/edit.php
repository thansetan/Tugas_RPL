    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Mesin Edit</h3>
            </div>
			<?php echo form_open('mesin/edit/'.$mesin['id_mesin']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_perusahaan" class="form-control">
								...
								{
									$selected = ($perusahaan['id_perusahaan'] == $mesin['id_perusahaan']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="nama" class="form-control" id="nama"><?php echo ($this->input->post('nama') ? $this->input->post('nama') : $mesin['nama']); ?></textarea>
