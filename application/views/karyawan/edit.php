<div class="row">
	<div class="col-md-12">
		<div class="box box-info">
			...
			<?php echo form_open('karyawan/edit/' . $karyawan['id_karyawan']); ?>
			<div class="box-body">
				<div class="row clearfix">
						...
						<div class="form-group">
							<select name="id_shift" class="form-control">
								...
								foreach ($all_shift as $shift) {
									$selected = ($shift['id_shift'] == $karyawan['id_shift']) ? ' selected="selected"' : "";
						...
						<div class="form-group">
							<select name="id_perusahaan" class="form-control">
								...
								foreach ($all_perusahaan as $perusahaan) {
									$selected = ($perusahaan['id_perusahaan'] == $karyawan['id_perusahaan']) ? ' selected="selected"' : "";
						...
						<div class="form-group">
							<select name="id_mesin" class="form-control">
								...
								foreach ($all_mesin as $mesin) {
									$selected = ($mesin['id_mesin'] == $karyawan['id_mesin']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="nama" class="form-control" id="nama"><?php echo ($this->input->post('nama') ? $this->input->post('nama') : $karyawan['nama']); ?></textarea>
